...
export const metadata: Metadata = {
  title: "Start Free Trial - Clickbail Bail Bonds Management Software",
  description: "Start your 30-day free trial of Clickbail bail bonds software. No setup fees, no contracts. Get GPS tracking, court management, and financial tools for your bonding company.",
  ...
  openGraph: {
    title: "Start Your Free 30-Day Trial - Clickbail",
  ...
  twitter: {
    ...
    title: "Start Free Trial - Clickbail Bail Bonds Software",
